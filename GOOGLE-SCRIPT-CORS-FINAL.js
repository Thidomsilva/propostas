// =============================================
// CÓDIGO GOOGLE APPS SCRIPT - VERSÃO CORS
// =============================================
// VERSÃO ESPECÍFICA PARA RESOLVER CORS
...
function atualizarSolicitacao(dados) {
  try {
    ...
    aba.getRange(linha, 8).setValue(new Date().toLocaleDateString('pt-BR') + ' ' + new Date().toLocaleTimeString('pt-BR'));
